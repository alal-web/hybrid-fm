...
#include "ui_hfm_sessiondlg_base.h"
#include "ui_hfm_newsessiondlg_base.h"
    ...
    , d(new KonqSessionDlgPrivate(manager, this))
{
    ...
    d->m_pOpenTabsInsideCurrentWindow->setChecked(
        HybridFMSettings::openTabsInsideCurrentWindow());
...
{
    HybridFMSettings::setOpenTabsInsideCurrentWindow(
