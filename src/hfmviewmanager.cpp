        ...
        bool openUrl)
{
    ...
    if (openUrl && !forcedUrl.isEmpty()) {
        ...
        _req.openAfterCurrentPage = HybridFMSettings::openAfterCurrentPage();
...
{
    tabContainer()->setAlwaysTabbedMode(HybridFMSettings::alwaysTabbedMode());
    tabContainer()->setTabsClosable(HybridFMSettings::permanentCloseButton());
}
