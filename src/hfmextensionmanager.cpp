    ...
    : QDialog(parent)
{
    ...
    if (activePart) {
        ...
        d->pluginSelector->setConfig(KSharedConfig::openConfig(QStringLiteral("hybrid-fmrc"))->group("KParts Plugins"));
    }
    addPluginForId(QStringLiteral("hybrid-fm")); // Always add the plugins from the hybrid-fm namespace
