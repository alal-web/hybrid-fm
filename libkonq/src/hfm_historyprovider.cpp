#include "hfm_historyprovider.h"

#include <kconfiggroup.h>
#include <ksharedconfig.h>
#include "hfm_historyloader_p.h"
...
public:
    ...
    {
        // We want to use hybrid-fmrc even when this class isn't used in konqueror,
        // this is why this doesn't say KSharedConfig::openConfig().
        return KSharedConfig::openConfig(QStringLiteral("hybrid-fmrc"));
    }
...
#include "hfm_historyprovider.moc"
