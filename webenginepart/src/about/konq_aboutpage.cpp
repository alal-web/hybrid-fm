...
QString KonqAboutPageSingleton::launch()
{
    ...
    QString res = loadFile(QStandardPaths::locate(QStandardPaths::GenericDataLocation, QStringLiteral("hybrid-fm/about/launch.html")));
    if (res.isEmpty()) {
        return res;
    }
    ...
    res = res.arg(i18nc("KDE 4 tag line, see http://kde.org/img/kde40.png", "Be free."))
          ...
          .arg(i18n("HybridFM is a file manager and web browser."))
          .arg(i18nc("Link that points to the first page of the about page, Starting Points contains links to Home, Network Folders, Trash, etc.", "Starting Points"))
          ...
          .arg(i18n("Next: An Introduction to HybridFM"))
          ;
...
QString KonqAboutPageSingleton::intro()
{
    ...
    QString res = loadFile(QStandardPaths::locate(QStandardPaths::GenericDataLocation, QStringLiteral("hybrid-fm/about/intro.html")));
    if (res.isEmpty()) {
        return res;
    }
    ...
    res = res.arg(i18nc("KDE 4 tag line, see http://kde.org/img/kde40.png", "Be free."))
          ...
          .arg(i18n("Tips"))
          .arg(i18n("Specifications"))
          .arg(i18n("HybridFM makes working with and managing your files easy. You can browse "
                    "both local and networked folders while enjoying advanced features "
                    "such as the powerful sidebar and file previews."
                   ))
          .arg(i18n("HybridFM is also a full featured and easy to use web browser which you "
          ...
          .arg(i18n("For more detailed documentation on HybridFM click <a href=\"%1\">here</a>.",
...
QString KonqAboutPageSingleton::specs()
{
    ...
    KIconLoader *iconloader = KIconLoader::global();
    QString res = loadFile(QStandardPaths::locate(QStandardPaths::GenericDataLocation, QStringLiteral("hybrid-fm/about/specs.html")));
    QString continue_icon_path = QUrl::fromLocalFile(iconloader->iconPath(QApplication::isRightToLeft() ? "go-previous" : "go-next", KIconLoader::Small)).toString();
    if (res.isEmpty()) {
        return res;
    }
    ...
    res = res.arg(i18nc("KDE 4 tag line, see http://kde.org/img/kde40.png", "Be free."))
          ...
          .arg(i18n("Specifications"))
          .arg(i18n("Specifications"))
          .arg(i18n("HybridFM is designed to embrace and support Internet standards. "
                    ...
                    "HybridFM also implements:", QStringLiteral("http://xbel.sourceforge.net/")))
          ...
          .arg(i18nc("A feature of HybridFM", "URL-Completion"))
          .arg(i18n("Manual"))
          .arg(i18n("Popup"))
          .arg(i18n("(Short-) Automatic"))
          .arg(QStringLiteral("<img width='16' height='16' src=\"%1\">")).arg(continue_icon_path)
          .arg(i18nc("Link that points to the first page of the about page", "<a href=\"%1\">Return to Starting Points</a>", QStringLiteral("konq:hybrid-fm")))
...
QString KonqAboutPageSingleton::tips()
{
    ...
    QString res = loadFile(QStandardPaths::locate(QStandardPaths::GenericDataLocation, QStringLiteral("hybrid-fm/about/tips.html")));
    if (res.isEmpty()) {
        return res;
    }
    ...
    res = res.arg(i18nc("KDE 4 tag line, see http://kde.org/img/kde40.png", "Be free."))
          ...
          .arg(i18n("Divide et impera (lat. \"Divide and conquer\") - by splitting a window "
                    ...
                    "Left/Right) you can make HybridFM appear the way you like.", view_left_right_icon_path))
          ...
          .arg(i18n("Advanced users will appreciate the Konsole which you can embed into "
                    "HybridFM (Settings -> <img width='16' height='16' SRC=\"%1\"></img> Show "
...
QString KonqAboutPageSingleton::plugins()
{
    ...
    QString res = loadFile(QStandardPaths::locate(QStandardPaths::GenericDataLocation, qApp->layoutDirection() == Qt::RightToLeft ? "hybrid-fm/about/plugins_rtl.html" : "hybrid-fm/about/plugins.html"))
