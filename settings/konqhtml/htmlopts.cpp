...
{
    m_pConfig = KSharedConfig::openConfig(QStringLiteral("hybrid-fmrc"), KConfig::NoGlobals);
    QVBoxLayout *lay = new QVBoxLayout(this);

    // Bookmarks
    setQuickHelp(i18n("<h1>HybridFM Browser</h1> Here you can configure HybridFM's browser "
                      ...
                      "settings how HybridFM should handle the HTML code in "
    ...
    m_pAdvancedAddBookmarkCheckBox->setToolTip(i18n("If this box is checked, HybridFM will allow you to"
    ...
    m_pOnlyMarkedBookmarksCheckBox->setToolTip(i18n("If this box is checked, HybridFM will show only those"
    ...
    m_pFormCompletionCheckBox->setToolTip(i18n("If this box is checked, HybridFM will remember"
    ...
    m_pMaxFormCompletionItems->setToolTip(
        i18n("Here you can select how many values HybridFM will remember for a form field."));
    ...
    m_pBackRightClick->setToolTip(i18n(
                                        "If this box is checked, you can go back in history by right clicking on a HybridFM view. "
    ...
    m_pAutoRedirectCheckBox->setToolTip(i18n("Some web pages request an automatic reload or redirection after"
                                          " a certain period of time. By unchecking this box HybridFM will ignore these requests."));
    ...
    m_pAccessKeys->setToolTip(i18n("Pressing the Ctrl key when viewing webpages activates Access Keys. Unchecking this box will disable this accessibility feature. (HybridFM needs to be restarted for this change to take effect.)"));
...
void KMiscHTMLOptions::load()
{
    ...
    // Read the configuration from hybrid-fmrc with khtmlrc as fall back.
