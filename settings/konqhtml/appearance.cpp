...

{
    ...
    m_pAutoLoadImagesCheckBox->setToolTip(i18n("<html>If this box is checked, HybridFM will"
    ...
    m_pUnfinishedImageFrameCheckBox->setToolTip(i18n("<html>If this box is checked, HybridFM will draw"
    ...
    m_pAnimationsCombo->setToolTip(i18n("<html>Controls how HybridFM shows animated images:<br />"
    ...
    m_pUnderlineCombo->setToolTip(i18n(
                                      "<html>Controls how HybridFM handles underlining hyperlinks:<br />"
    ...
    m_pSmoothScrollingCombo->setToolTip(i18n(
                                            "<html>Determines whether HybridFM should use smooth steps to scroll HTML pages, or whole steps:<br />"
    ...
    setQuickHelp(i18n("<h1>HybridFM Fonts</h1>On this page, you can configure "
                      "which fonts HybridFM should use to display the web "
    ...
    gb->setToolTip(i18n("This is the relative font size HybridFM uses to display web sites."));
    ...
    m_minSize->setToolTip("<qt>" + i18n("HybridFM will never display text smaller than "
    ...
    m_MedSize->setToolTip(
        i18n("This is the relative font size HybridFM uses "
