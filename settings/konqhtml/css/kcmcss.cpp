    ...
    , customDialog(new CSSCustomDialog(customDialogBase))
{
    ...
    setToolTip(i18n("<h1>HybridFM Stylesheets</h1> This module allows you to apply your own color"
                      " and font settings to HybridFM by using"
...
void CSSConfig::save()
{
    ...
    c = new KConfig(QStringLiteral("hybrid-fmrc"), KConfig::NoGlobals);
