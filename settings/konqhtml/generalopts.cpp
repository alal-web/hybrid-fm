...
static const char DEFAULT_STARTPAGE[] = "https://astralinux.ru";
static const char DEFAULT_HOMEPAGE[] = "https://astralinux.ru";
...
void KKonqGeneralOptions::addHomeUrlWidgets(QVBoxLayout *lay)
{
    ...
    QLabel *startLabel = new QLabel(i18nc("@label:listbox", "When &HybridFM starts:"), this);
    ...
    QString startstr = i18n("This is the URL of the web page "
                           "HybridFM will show when starting.");
