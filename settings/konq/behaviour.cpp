...
KBehaviourOptions::KBehaviourOptions(QWidget *parent, const QVariantList &)
    : KCModule(parent)
    , g_pConfig(KSharedConfig::openConfig(QStringLiteral("hybrid-fmrc"), KConfig::IncludeGlobals))
    , groupname(QStringLiteral("FMSettings"))
{
    setQuickHelp(i18n("<h1>HybridFM Behavior</h1> You can configure how HybridFM behaves as a file manager here."));
    ...
    cbNewWin->setToolTip(i18n("If this option is checked, HybridFM will open a new window when "
